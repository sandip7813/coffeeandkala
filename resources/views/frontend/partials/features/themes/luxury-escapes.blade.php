            ...
            @foreach ($category['articles'] as $article)
                <article @class([
                    ...
                    <a href="{{ $article['href'] }}" class="fc-lux-panel-link">
                        <img src="{{ $article['image'] }}" alt="" class="fc-lux-panel-image" loading="lazy"
                            width="1400" height="700" decoding="async">
                        <div class="fc-lux-panel-veil" aria-hidden="true"></div>
                        <div class="fc-lux-panel-copy">
                            <div class="fc-lux-panel-meta">
                                <span
                                    class="fc-lux-panel-no">{{ str_pad((string) $loop->iteration, 2, '0', STR_PAD_LEFT) }}</span>
