...
@section('content_header')
    <div class="row">
        ...
        <div class="col-sm-6 d-flex justify-content-sm-end">
            <button type="button" class="btn btn-outline-info" data-search-toggle="#categorySearch" aria-expanded="{{ $hasActiveFilters ? 'true' : 'false' }}" aria-controls="categorySearch">
